...
╠════════╬═════════════╬══════════════════════════════════════════════════════╣
║   4    ║ Líder       ║ Tudo — tag, slogan, liderança, base, deletar gang    ║
║   3    ║ Comandante  ║ Convidar, expulsar, gerenciar levels, comprar base   ║
║   2    ║ Membro      ║ Combate, dominar territórios, pickups, veículos      ║
...
As **8 Gang Zonas** em Las Venturas:
...
- Se o **defensor vencer** → **+1.000 XP** e mantém o território
- Se o **atacante vencer** → rouba o XP total da zona e derruba o XP do defensor
...
╠══════════════════════════╬═════════════╬════════════════════════════════╬════════════════════╣
║ 🏜️ Area 51              ║ $1.000.000  ║ 🚁 Hunter (Helicóptero Ataque) ║ Deserto            ║
║ 🏭 Fabrica               ║ $525.000    ║ ✈️ Hydra (Caça VTOL)           ║ LV Norte           ║
║ 🪖 Departamento Militar  ║ $500.000    ║ 🛡️ Rhino (Tanque)              ║ Las Venturas       ║
║ 🏗️ Construção            ║ $475.000    ║ 🚁 Seasparrow (Heli Armado)    ║ LV Leste           ║
║ 🏚️ Garagem               ║ $450.000    ║ 🚁 Seasparrow (Heli Armado)    ║ Las Venturas       ║
╚══════════════════════════╩═════════════╩════════════════════════════════╩════════════════════╝
```

### O que cada base inclui:
- **Frota de veículos** exclusiva da gang (15–22 veículos, incluindo carros e motos)
- **Pickups de armas**, saúde e armadura — apenas para membros da gang dona
- **Portão animado** que abre automaticamente para membros (fecha para inimigos)
- **Veículo especial** com acesso restrito + cooldown de 10 minutos após uso

### Mecânica de Venda/Compra de Base
- Se outra gang comprar sua base, o **dinheiro vai para o membro de mais alto nível** online da gang anterior
...
Prioridade de Respawn:
  1. Gang tem BASE        →  Renasce na base
  2. Gang tem GANG ZONA   →  Renasce na gang zona de menor ID
  3. Sem base/gang zona   →  Ponto aleatório em Las Venturas
```

### Bônus das Villas no Respawn
- 🛡️ **Fort Carson:** Gang dona recebe **+100 de armadura** ao nascer
...
**Danos balanceados pelo servidor:**
...
- Cada jogador tem **dinheiro em mão** (reset para $500 ao morrer) e **saldo bancário** (persiste entre mortes e sessões)
...
```
XP da gang = soma de todos os territórios dominados atualmente
```

```
Ação                   │  Resultado
───────────────────────┼──────────────────────────
Ganhar ataque          │  +XP do território
Defender com sucesso   │  +1.000 XP fixo
...
Comprar Base           │  10.000 XP (+ 12.000 para manter acesso)
```
...
Não apenas conquiste — **defenda suas zonas ativamente**. Uma defesa bem-sucedida rende **+1.000 XP** fixo, independente do valor da zona.
